...
public final class JsonUtils {
  ...
  /**
   * Converts the given JSON stream to a JSON Object. This method is useful when we want to explore
   * on the content of the JSON stream.
   *
  ...
  /**
   * Restores an object of the given class based on the given JSON stream with a list of adapters.
   *
   * @param <T>
   * @param json JSON stream
   * @param clazz Class of JSON stream
