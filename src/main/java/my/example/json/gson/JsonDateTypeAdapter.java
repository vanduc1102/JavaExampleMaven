...
public class JsonDateTypeAdapter implements JsonDeserializer<Date>, JsonSerializer<Date> {
  ...
  /**
   * Register an adapter to manage the date types that are received as long values on json
  ...
  /**
   * Register an adapter to manage the date types and serialize date as ISO 8601 when creating a
   * json string. Always serialize the date with ISO long pattern.
   *
   * @param date
   * @param typeOfT
   * @param context
