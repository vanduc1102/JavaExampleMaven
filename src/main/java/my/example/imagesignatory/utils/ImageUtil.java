...
public class ImageUtil {
  ...
  public static String addBackgroundToImage(String backgroundPATH, String imagePath) {
    try {
      ...
      signAndText =
          signAndText.getScaledInstance(backgroundWidth, backgroundHeight, Image.SCALE_SMOOTH);
  ...
  public static String createImageSignatory(
      String backgroundPath, String signatoryPath, String textImagePath) {
    try {
      String tempFileName = IOUtils.getTemporyFilePath();
      Image backgroundImage = ImageIO.read(new File(backgroundPath));
      int backgroundWidth = backgroundImage.getWidth(null);
  ...
  public static String createImageFromText(
