...
public class PDFUtils {
    ...
    public static byte[] addImageToPdf(byte[] pdfData, BufferedImage image, Sign sign) throws IOException {
        PDDocument doc = null;
        ...
        try {
            ...
            float[] demension = getCorrectImagePosition(correctX, correctY, imageWidth, imageHeight, bi.getWidth(), bi.getHeight());
    ...
    /**
     * This method get convert position of dsbSign to position of PDF with
     * coordinate from bottom-left
     *
     * @param dsbSign
     * @param doc
     * @return
    ...
    public static float[] getSuisseIdSignaturePosition(Sign dsbSign, byte[] doc) {
        ...
        if (dsbSign.getWidth() == null || dsbSign.getHeight() == null
                || dsbSign.getX() == null || dsbSign.getY() == null) {
            return rect;
        }
     ...
     * @return
     */
    private static float[] getCorrectImagePosition(float currentX, float currentY, float rectangleWidth, float rectangleHeight, float imageWidth, float imageHeight) {
    ...
    /**
     * This method get convert position of dsbSign to position of PDFBox with
     * coordinate from bottom-left
     *
     * @param dsbSign
     * @param degree
