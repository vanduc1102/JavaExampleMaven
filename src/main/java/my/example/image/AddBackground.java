...
public class AddBackground {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage bi = addBackgroundToImageKeepRatio2(ImageIO.read(new File(background)), ImageIO.read(new File(signatory)));
        ImageIO.write(bi, "PNG", Paths.get("target", "result2.png").toFile());
    }

    public static BufferedImage addBackgroundToImageKeepRatio2(Image backgroundImage, BufferedImage signatureImage) {
