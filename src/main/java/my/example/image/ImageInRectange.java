...
public class ImageInRectange {
  ...
  public static void main(String[] args) throws IOException {
    createImageInRectangle(512, 256, new File("./src/main/resources/chelsea.png"));
  }

  private static File createImageInRectangle(int width, int height, File image) throws IOException {
