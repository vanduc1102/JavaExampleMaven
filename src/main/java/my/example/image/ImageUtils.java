...
import my.example.javaexamplemaven.utils.IOUtils;
...
public class ImageUtils {
    ...
    private final static org.slf4j.Logger log = LoggerFactory.getLogger(ImageUtils.class);
    ...
    public static BufferedImage addBackgroundToImage(Image backgroundImage, BufferedImage signAndTextBufferedImage) {
        int backgroundWidth = backgroundImage.getWidth(null);
        int backgroundHeight = backgroundImage.getHeight(null);

        Image signAndText = signAndTextBufferedImage.getScaledInstance(backgroundWidth, backgroundHeight, Image.SCALE_SMOOTH);
    ...
    public static BufferedImage addBackgroundToImageKeepRatio(Image backgroundImage, BufferedImage signatureImage) {
        int backgroundWidth = backgroundImage.getWidth(null);
        int backgroundHeight = backgroundImage.getHeight(null);
        ...
        if (newOriginImageWidth > backgroundWidth) {
            ...
            originImage = originImage.getScaledInstance(newOriginImageWidth, newOriginImageHeight, Image.SCALE_SMOOTH);
    ...
    public static BufferedImage createImageSignatory(Image backgroundImage, BufferedImage signatoryImageBuffered, BufferedImage textImageBuffered) {
        ...
        if (backgroundRemainingHeight <= 0) {
            log.info("The image text is too height,We dont have place for Signatory image. Reducing the lenght of the signatory reason may help.");
        }
    ...
    public static BufferedImage mergeTwoImage(BufferedImage first, BufferedImage second, boolean isHasBackground) {
    ...
    public static BufferedImage createImageFromText(String text, boolean isNeededBackground, final int fontSize) {
