...
import my.example.javaexamplemaven.utils.ImageUtil;
...
public class CreateImageSignatory {
    ...
    public String createSignImage(String signType, String backgroundPath, String reasonText, int lineLength, int fontSize, Boolean isIncludeText) {
        ...
        try {
            ...
            if (backgroundImagePath == null) {
                ...
                if(isIncludeText){
                return ImageUtil.createImageSignatory(backgroundImagePath, signImageFileOfUserPath, textImagePath);
...
//            log.debug("createSignImage ", ex);
    ...
    private String createImageReasonImage(String text, boolean isNeededBackground, int lineLength, int fontSize) {
